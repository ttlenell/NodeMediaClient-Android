 ...
 * 直播推流实例
 */
public class LivePublisherDemoActivity extends AppCompatActivity implements View.OnClickListener, LivePublisherDelegate {
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            case R.id.pub_cap_button:
                ...
                LivePublisher.capturePicture(capFilePath);
