...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    Button livePlayerBtn, livePublisherBtn, multiPlayerBtn, vodPlayerBtn,nodeStreamerBtn;
    EditText playUrl, pubUrl, bufferTime, maxBufferTime,vodPlayUrl,vodBufferTime,vodMaxBufferTime;
